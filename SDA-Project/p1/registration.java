...
public class registration extends JFrame
{
	...
	public registration() {
		...
		JLabel lblNewLabel = new JLabel("Join as a Customer ");
		...
		btnNewButton_1.setBounds(685, 611, 89, 23);
			...
			public void actionPerformed(ActionEvent e) 
			{
				...
				try
				{
					...
					else
					{
						...
						if(check == false)
						{
							JOptionPane.showInternalMessageDialog(null, "Customer with the same username already exists");
						}
						else
						{
		...
		btnNewButton_2.setBounds(560, 611, 110, 23);
