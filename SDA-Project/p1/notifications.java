  ...
  //private Register r = demo.getSharedObject();
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					notifications frame = new notifications("abc");
	...
	public notifications(String username) 
	{
		...
		JButton btnNewButton_8 = new JButton("Save in File");
		btnNewButton_8.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				String selectQuery = "SELECT * FROM applications WHERE TRIM(Freelancer) = ?  and Status = ?";
	    	    int i = 1;
	    	         ...
	    	         PreparedStatement preparedStatement = con.prepareStatement(selectQuery))
	    	    {
	    	        ...
	    	        while (resultSet.next())
	    	        {
	    	            ...
	    	            String ser = resultSet.getString("Service");
	    	            r.storeNotifications(1,customer,username,ser);
	    	        }
		...
		btnNewButton_8.setBounds(235, 466, 120, 23);
		panel_2.add(btnNewButton_8);
		
		    
		     /*try (Connection connection = DriverManager.getConnection(url, un, p))
		    	{
		    		String query = "SELECT * FROM applications WHERE TRIM(Freelancer)  = ?";
		    		try (PreparedStatement preparedStatement = connection.prepareStatement(query))
		    		{
		    			...
		    			try (ResultSet resultSet = preparedStatement.executeQuery())
		    			{
		    				...
		    				// Add column names to the model (optional)
		    				...
		    				if (table == null) 
		    				{
		    					...
		    					panel_2.setBounds(357, 11, 579, 500);
		    					//scrollPane.getViewport().setBackground(new Color(53, 44, 68));
	    	         ...
	    	         PreparedStatement preparedStatement = con.prepareStatement(selectQuery))
	    	    {
	    	        ...
	    	        while (resultSet.next())
	    	        {
	    	            ...
	    	            String message = customer + " sent an application for " + ser + " service";
	    	        ...
	    	        if (table == null) 
    				{
    				    ...
    				    Index.setMinWidth(50); // Set the minimum width
    				    Index.setMaxWidth(100); // Set the maximum width
    				} 
    				else
    				{
    					// Set the model to the existing table
